...
import { MoveLeft, MoveRight, ChevronsLeft, ChevronsRight, Undo } from "lucide-react";
...
export default function KitchenSidebar({ page, pageCount, setPage, goToPreviousPage, handleUndo, canUndo }: KitchenSidebarProps) {
    return (
